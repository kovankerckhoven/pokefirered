...
{
 /* 0x00 */ u16 moves[MAX_MON_MOVES]; // Move IDs are defined in include\constants\moves.h
 /* 0x08 */ u8 pp[MAX_MON_MOVES]; // Max PP is defined in src\data\battle_moves.h
}; /* 0x0C = 12 bytes */
...
struct BoxPokemon
{
 ...
 /* 0x12 */ u8 language;
 /* 0x13 */ u8 isBadEgg:1;
 /* 0x00 */ u8 hasSpecies:1;
 /* 0x00 */ u8 isEgg:1;
 /* 0x00 */ u8 unused:5;
 /* 0x14 */ u8 otName[PLAYER_NAME_LENGTH];
 /* 0x1B */ u8 markings;
 /* 0x1C */ u16 checksum;
 /* 0x1E */ u16 unknown; // TODO: Perhaps this is important?
