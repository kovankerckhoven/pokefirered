...
#define KANTO_SPECIES_BEGIN SPECIES_BULBASAUR
...
#define JOHTO_SPECIES_BEGIN SPECIES_CHIKORITA
...
#define HOEHN_SPECIES_BEGIN SPECIES_TREECKO
#define HOEHN_SPECIES_END SPECIES_DEOXYS

#define NATIONAL_DEX_SPECIES_BEGIN KANTO_SPECIES_BEGIN
#define NATIONAL_DEX_SPECIES_END HOEHN_SPECIES_END

#define SPECIES_EGG (NATIONAL_DEX_SPECIES_END + 1)
