...
const u8 gText_BoulderBadge[] = _("BOULDERBADGE"); // TODO: Why are these defined twice?
const u8 gText_CascadeBadge[] = _("CASCADEBADGE");
const u8 gText_ThunderBadge[] = _("THUNDERBADGE");
const u8 gText_RainbowBadge[] = _("RAINBOWBADGE");
const u8 gText_SoulBadge[] = _("SOULBADGE");
...
const u8 gText_VolcanoBadge[] = _("VOLCANOBADGE");
const u8 gText_EarthBadge[] = _("EARTHBADGE");
const u8 gText_ZephyrBadge[] = _("ZEPHYRBADGE");
const u8 gText_HiveBadge[] = _("HIVEBADGE");
const u8 gText_PlainBadge[] = _("PLAINBADGE");
const u8 gText_FogBadge[] = _("FOGBADGE");
const u8 gText_StormBadge[] = _("STORMBADGE");
const u8 gText_MineralBadge[] = _("MINERALBADGE");
const u8 gText_GlacierBadge[] = _("GLACIERBADGE");
const u8 gText_RisingBadge[] = _("RISINGBADGE");
