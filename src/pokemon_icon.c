...
const u8 *const gMonIconTable[] = {
    ...
    [SPECIES_DIGLETT]     = gMonIcon_Diglett, // Diglett is #50 in the National Dex
    ...
    [SPECIES_VOLTORB]     = gMonIcon_Voltorb, // Voltorb is #100 in the National Dex
    ...
    [SPECIES_MEWTWO]      = gMonIcon_Mewtwo, // Mewtwo is #150 in the National Dex
    ...
    [SPECIES_MISDREAVUS]  = gMonIcon_Misdreavus, // Misdreavus is #200 in the National Dex
    ...
    [SPECIES_HO_OH]       = gMonIcon_HoOh, // Ho-oh is #250 in the National Dex
    ...
    [SPECIES_SKITTY]      = gMonIcon_Skitty, // Skitty is #300 in the National Dex
    ...
    [SPECIES_MILOTIC]     = gMonIcon_Milotic, // Milotic is #350 in the National Dex
    ...
    [SPECIES_EGG]         = gMonIcon_Egg, // Egg sprite
    [SPECIES_UNOWN_B]     = gMonIcon_UnownB, // Other Unown letters (A is the default at #201)
...
const u8 gMonIconPaletteIndices[] = {
    ...
    [SPECIES_VENONAT]     = 0,
    [SPECIES_VENOMOTH]    = 2,
    [SPECIES_DIGLETT]     = 2, // Diglett is #50 in the National Dex
    [SPECIES_DUGTRIO]     = 2,
    [SPECIES_MEOWTH]      = 1,
    [SPECIES_PERSIAN]     = 1,
    [SPECIES_PSYDUCK]     = 1,
    ...
    [SPECIES_KRABBY]      = 2,
    [SPECIES_KINGLER]     = 2,
    [SPECIES_VOLTORB]     = 0, // Voltorb is #100 in the National Dex
    [SPECIES_ELECTRODE]   = 0,
    [SPECIES_EXEGGCUTE]   = 0,
    [SPECIES_EXEGGUTOR]   = 1,
    [SPECIES_CUBONE]      = 1,
    ...
    [SPECIES_DRAGONAIR]   = 0,
    [SPECIES_DRAGONITE]   = 2,
    [SPECIES_MEWTWO]      = 2, // Mewtwo is #150 in the National Dex
    [SPECIES_MEW]         = 0,
    [SPECIES_CHIKORITA]   = 1,
    [SPECIES_BAYLEEF]     = 1,
    [SPECIES_MEGANIUM]    = 1,
    ...
    [SPECIES_MURKROW]     = 2,
    [SPECIES_SLOWKING]    = 0,
    [SPECIES_MISDREAVUS]  = 0, // Misdreavus is #200 in the National Dex
    [SPECIES_UNOWN]       = 0,
    [SPECIES_WOBBUFFET]   = 0,
    [SPECIES_GIRAFARIG]   = 1,
    [SPECIES_PINECO]      = 0,
    ...
    [SPECIES_TYRANITAR]   = 1,
    [SPECIES_LUGIA]       = 0,
    [SPECIES_HO_OH]       = 1, // Ho-oh is #250 in the National Dex
    [SPECIES_CELEBI]      = 1,
    [SPECIES_TREECKO]     = 1,
    [SPECIES_GROVYLE]     = 0,
    [SPECIES_SCEPTILE]    = 1,
    ...
    [SPECIES_AZURILL]     = 2,
    [SPECIES_NOSEPASS]    = 0,
    [SPECIES_SKITTY]      = 0, // Skitty is #300 in the National Dex
    [SPECIES_DELCATTY]    = 2,
    [SPECIES_SABLEYE]     = 2,
    [SPECIES_MAWILE]      = 2,
    [SPECIES_ARON]        = 2,
    ...
    [SPECIES_ARMALDO]     = 0,
    [SPECIES_FEEBAS]      = 2,
    [SPECIES_MILOTIC]     = 0, // Milotic is #350 in the National Dex
    [SPECIES_CASTFORM]    = 0,
    [SPECIES_KECLEON]     = 1,
    [SPECIES_SHUPPET]     = 0,
    [SPECIES_BANETTE]     = 0,
    ...
    [SPECIES_JIRACHI]     = 0,
    [SPECIES_DEOXYS]      = 0,
    [SPECIES_EGG]         = 1, // Egg sprite palette
    [SPECIES_UNOWN_B]     = 0, // Other Unown letters palette (A is the default at #201)
    [SPECIES_UNOWN_C]     = 0,
    [SPECIES_UNOWN_D]     = 0,
    [SPECIES_UNOWN_E]     = 0,
    [SPECIES_UNOWN_F]     = 0,
