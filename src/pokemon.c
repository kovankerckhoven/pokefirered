...
// TODO: Clean these up and the methods using them?
...
static const u16 sSpeciesToHoennPokedexNum[] = // Assigns all species to the Hoenn Dex Index (Summary No. for Hoenn Dex)
{
    ...
    SPECIES_TO_HOENN(UNOWN_B),
    SPECIES_TO_HOENN(UNOWN_C),
    SPECIES_TO_HOENN(UNOWN_D),
    SPECIES_TO_HOENN(UNOWN_E),
    SPECIES_TO_HOENN(UNOWN_F),
    SPECIES_TO_HOENN(UNOWN_G),
    SPECIES_TO_HOENN(UNOWN_H),
    SPECIES_TO_HOENN(UNOWN_I),
    SPECIES_TO_HOENN(UNOWN_J),
    SPECIES_TO_HOENN(UNOWN_K),
    SPECIES_TO_HOENN(UNOWN_L),
    SPECIES_TO_HOENN(UNOWN_M),
    SPECIES_TO_HOENN(UNOWN_N),
    SPECIES_TO_HOENN(UNOWN_O),
    SPECIES_TO_HOENN(UNOWN_P),
    SPECIES_TO_HOENN(UNOWN_Q),
    SPECIES_TO_HOENN(UNOWN_R),
    SPECIES_TO_HOENN(UNOWN_S),
    SPECIES_TO_HOENN(UNOWN_T),
    SPECIES_TO_HOENN(UNOWN_U),
    SPECIES_TO_HOENN(UNOWN_V),
    SPECIES_TO_HOENN(UNOWN_W),
    SPECIES_TO_HOENN(UNOWN_X),
    SPECIES_TO_HOENN(UNOWN_Y),
    SPECIES_TO_HOENN(UNOWN_Z),
...
static const u16 sSpeciesToNationalPokedexNum[] = // Assigns all species to the National Dex Index (Summary No. for National Dex)
{
    ...
    SPECIES_TO_NATIONAL(UNOWN_B),
    SPECIES_TO_NATIONAL(UNOWN_C),
    SPECIES_TO_NATIONAL(UNOWN_D),
    SPECIES_TO_NATIONAL(UNOWN_E),
    SPECIES_TO_NATIONAL(UNOWN_F),
    SPECIES_TO_NATIONAL(UNOWN_G),
    SPECIES_TO_NATIONAL(UNOWN_H),
    SPECIES_TO_NATIONAL(UNOWN_I),
    SPECIES_TO_NATIONAL(UNOWN_J),
    SPECIES_TO_NATIONAL(UNOWN_K),
    SPECIES_TO_NATIONAL(UNOWN_L),
    SPECIES_TO_NATIONAL(UNOWN_M),
    SPECIES_TO_NATIONAL(UNOWN_N),
    SPECIES_TO_NATIONAL(UNOWN_O),
    SPECIES_TO_NATIONAL(UNOWN_P),
    SPECIES_TO_NATIONAL(UNOWN_Q),
    SPECIES_TO_NATIONAL(UNOWN_R),
    SPECIES_TO_NATIONAL(UNOWN_S),
    SPECIES_TO_NATIONAL(UNOWN_T),
    SPECIES_TO_NATIONAL(UNOWN_U),
    SPECIES_TO_NATIONAL(UNOWN_V),
    SPECIES_TO_NATIONAL(UNOWN_W),
    SPECIES_TO_NATIONAL(UNOWN_X),
    SPECIES_TO_NATIONAL(UNOWN_Y),
    SPECIES_TO_NATIONAL(UNOWN_Z),
...
static const u16 sHoennToNationalOrder[] = // Assigns Hoenn Dex Pokémon (Using National Dex Index)
{
    ...
    HOENN_TO_NATIONAL(UNOWN_B),
    HOENN_TO_NATIONAL(UNOWN_C),
    HOENN_TO_NATIONAL(UNOWN_D),
    HOENN_TO_NATIONAL(UNOWN_E),
    HOENN_TO_NATIONAL(UNOWN_F),
    HOENN_TO_NATIONAL(UNOWN_G),
    HOENN_TO_NATIONAL(UNOWN_H),
    HOENN_TO_NATIONAL(UNOWN_I),
    HOENN_TO_NATIONAL(UNOWN_J),
    HOENN_TO_NATIONAL(UNOWN_K),
    HOENN_TO_NATIONAL(UNOWN_L),
    HOENN_TO_NATIONAL(UNOWN_M),
    HOENN_TO_NATIONAL(UNOWN_N),
    HOENN_TO_NATIONAL(UNOWN_O),
    HOENN_TO_NATIONAL(UNOWN_P),
    HOENN_TO_NATIONAL(UNOWN_Q),
    HOENN_TO_NATIONAL(UNOWN_R),
    HOENN_TO_NATIONAL(UNOWN_S),
    HOENN_TO_NATIONAL(UNOWN_T),
    HOENN_TO_NATIONAL(UNOWN_U),
    HOENN_TO_NATIONAL(UNOWN_V),
    HOENN_TO_NATIONAL(UNOWN_W),
    HOENN_TO_NATIONAL(UNOWN_X),
    HOENN_TO_NATIONAL(UNOWN_Y),
    HOENN_TO_NATIONAL(UNOWN_Z),
};
