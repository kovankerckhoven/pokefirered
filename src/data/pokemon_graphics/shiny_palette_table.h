const struct CompressedSpritePalette gMonShinyPaletteTable[] =
{
    ...
    SPECIES_SHINY_PAL(DIGLETT, gMonShinyPalette_Diglett), // Diglett is #50 in the National Dex
    ...
    SPECIES_SHINY_PAL(VOLTORB, gMonShinyPalette_Voltorb), // Voltorb is #100 in the National Dex
    ...
    SPECIES_SHINY_PAL(MEWTWO, gMonShinyPalette_Mewtwo), // Mewtwo is #150 in the National Dex
    ...
    SPECIES_SHINY_PAL(MISDREAVUS, gMonShinyPalette_Misdreavus), // Misdreavus is #200 in the National Dex
    ...
    SPECIES_SHINY_PAL(HO_OH, gMonShinyPalette_HoOh), // Ho-oh is #250 in the National Dex
    ...
    SPECIES_SHINY_PAL(SKITTY, gMonShinyPalette_Skitty), // Skitty is #300 in the National Dex
    ...
    SPECIES_SHINY_PAL(MILOTIC, gMonShinyPalette_Milotic), // Milotic is #350 in the National Dex
